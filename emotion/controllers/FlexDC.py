    ...
    def acceleration(self, axis, new_acc=None):
        ...
        if new_acc is None:
            ...
            try:
                ...
                _acc = _acc_spss / _spu
                flexdc_debug("emotion read Acceleration : _acc=%g spu=%g _acc_spss=%g " % (_acc, _spu, _acc_spss))
            ...
            try:
                ...
                flexdc_debug( "emotion write Acceleration : new_acc=%g, _spu=%g, _new_acc_spss=%g" % (new_acc, _spu, _new_acc_spss))
