...
def add_group(group_name, group_config, group_axes, group_class=Group):
    ...
    Args:
        ...
        group_class (class object):
            Defaults to :class:`emotion.group.Group`
...
def get_group(group_name):
    ...
    Returns:
        :class:`emotion.group.Group` object
...
def commit_settings(axis_config):
    if BACKEND == 'xml':
        from .xml_backend import commit_settings
    elif BACKEND == 'beacon':
        from .beacon_backend import commit_settings
